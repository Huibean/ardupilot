...
SPIDesc SPIDeviceManager::_device[] = {
    // SPIDesc("icm20649",   0, 0, SPI_MODE_3, 8, SPI_CS_KERNEL,  10*MHZ, 10*MHZ),
    // SPIDesc("icm20602",   0, 0, SPI_MODE_3, 8, SPI_CS_KERNEL,  4*MHZ, 10*MHZ),
    SPIDesc("icm20602",   0, 0, SPI_MODE_0, 8, SPI_CS_KERNEL,  4*MHZ, 10*MHZ),
    SPIDesc("icm20649",   0, 1, SPI_MODE_3, 8, SPI_CS_KERNEL,  10*MHZ, 10*MHZ),
};
